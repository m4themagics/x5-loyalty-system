...
Для обмена выберите в демо-стенде **«Аня · обмен»**, закройте стенд и нажмите зелёную иконку **«Обмен»** рядом с персонажем. Верхняя ячейка показывает все свободные предметы профиля, включая единственные копии. Добавьте молочный кувшин, нажмите на стрелки, покажите QR подключения и подтвердите обмен на сковороду. Затем переключитесь на **«Борис · обмен»**, снова откройте обмен и примите предложение; после возврата к Ане можно собрать «Доброе утро» на 8%. Если Python API недоступен на статическом хостинге, встроенный синтетический профиль сохраняет интерфейс обмена рабочим. QR и выбор подготовленного участника демонстрационные: реального соединения между телефонами и серверного реестра пока нет. Оба профиля имеют нужные предметы и два синтетических покупочных дня. Предложение живёт 24 часа; лимит — три завершённых обмена за последние семь дней. Зарезервированные копии недоступны для крафта.
