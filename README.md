...
Репозиторий содержит **локальный веб-прототип**: игровая коробка и персональные задания на синтетических покупках наполняют одну коллекцию. Товарные награды и погашение скидки демонстрационные.
...
Экран «Профиль» состоит из постоянной шапки и трёх вкладок: **«Задания»**, **«Коллекция»** и **«Друзья»**. Служебные инструменты демонстрации — подмена профиля, тестовый чек, сброс и панель «Для X5» — вынесены в **«Демо-стенд»**, кнопка внизу экрана.

1. Откройте **«Демо-стенд»**, нажмите **«Полный сброс демо»** и выберите профиль **«Новый участник, пустой инвентарь»**.
2. На вкладке **«Задания»** нажмите **«Показать задание»** — увидите заранее известные предмет и бесплатный SKU.
3. В стенде отправьте **«Оплаченную покупку нужной категории»**, нажмите **«Забрать»**, затем откройте **«Для X5»**: там видны победившая Ads-кампания и один начисленный CPA.
4. В стенде переключитесь на подготовленный профиль с тремя предметами «Доброго утра» и запросите следующее, уже органическое задание.
5. Проведите подходящий чек, получите сковороду и перейдите на вкладку **«Коллекция»**: перенесите четыре предмета в ячейки скидок.
6. Нажмите **«Создать скидку»**, получите купон со штрихкодом и попробуйте **«Погасить (демо)»**.
...
**Коробка** на вкладке «Задания» открывается без ограничений: нажмите на неё и встряхните движением пальца или указателя по экрану. Выпавший предмет попадает в ту же коллекцию, что и награды за задания, — инвентарь и сборка скидки в продукте одни.

Для обмена откройте «Демо-стенд», выберите профиль **«Аня»**, на вкладке «Коллекция» отдайте дубликат за нужный предмет и нажмите **«Предложить обмен»**. Переключитесь на **«Бориса»** → **«Принять обмен»**, затем вернитесь к Ане и соберите «Доброе утро». Оба профиля явно подготовлены: дубликаты и два синтетических покупочных дня. Предложение живёт 24 часа; лимит — три завершённых обмена за последние семь дней. Зарезервированные копии недоступны для крафта.
...
Основной персональный путь, квалификация чеков, резервы, сохранение прогресса и Qwen/fallback-карточка проверены локально. Итоговая автоматизированная приёмка — **223 проверки**: 70 тестов движка, 39 аналитических, 8 контрактных, 89 web-тестов и **17 сквозных Playwright-сценариев**. Следующий шаг — 5–7 пользовательских прохождений, экспертная проверка задания, репетиция и резервная запись. Результаты и ограничения собраны в [статусе PoC](docs/project/poc-status.md).
