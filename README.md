...
- три предмета каталога надеваются на него как косметика: фартук пекаря, нож шефа
  и золотой колпак. На размер скидки внешний вид не влияет;
...
На текущем состоянии проходят **250 автоматизированных проверок**:
