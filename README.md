...
На текущем состоянии проходят **257 автоматизированных проверок**: 11 контрактных, 101 web-тест, 84 теста Python-движка, 41 аналитический тест и 20 Playwright-сценариев. Подробности и границы — в [статусе PoC](docs/project/poc-status.md).
