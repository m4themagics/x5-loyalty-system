...
- PoC coupon promises share one funded pool and a uniform RUB 10 coupon cap: reserve RUB 2.50 for each unspent or promised-but-unissued item instance, plus the fixed maxima of issued unredeemed coupons. Never count a promise and its fulfilled instance twice. Crafting consumes four item reserves into one RUB 10 coupon reserve; local exchange preserves the pooled reserve. Physical SKU and advertiser CPA/subsidy budgets remain separate. The unlimited local demo box creates no financial entitlement.
