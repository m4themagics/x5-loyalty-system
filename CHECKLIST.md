...
| Local X5 decision and evaluation view | available | The «Для X5» screen shows decision explanation, funding and policy-comparison results with coverage, five-seed range and CPA break-even after new outstanding liabilities. The funded-onboarding policy remains evaluation-only; this is not a live advertiser console. Browser-checked locally. |
...
| Habit, relevance and economics evaluation | available | Reproducible local runs exist: 40 profiles with a separately stored rubric, eight refusal cases, four allocation policies on five seeds of 1,000 users with conservative reward liabilities, stress worlds and fraud precision/recall. Live Qwen checks three card facts on 15 synthetic personas; early failed protocols are preserved. Labels are `agent_draft` pending human confirmation; no human walkthroughs and no real 28-day purchase or margin measurement. |
