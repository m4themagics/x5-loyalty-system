...
| Digital item exchange | available | Local PoC only: Anya/Boris synthetic profiles, 1:1 same-rarity duplicates, 24h expiry, sender proposal and receiver confirmation, reserved copies, atomic local transfer, max 3 completed exchanges in rolling 7 days and 2 verified purchase days per user. Reload, acceptance, rejection and craft after exchange pass browser checks; no server ledger. |
