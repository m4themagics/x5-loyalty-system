...
Для PoC выбран единый купонный фонд с общим максимумом любого купона **100 ₽**. Каждый
непотраченный или обещанный, но ещё не выданный цифровой экземпляр обеспечивается **25 ₽**.
...
При крафте четыре резерва по 25 ₽ атомарно заменяются одним резервом купона 100 ₽; ничего
...
резервом 25 ₽ каждая плюс SKU себестоимостью 25 ₽ = 125 ₽; после товарного результата 100 ₽
