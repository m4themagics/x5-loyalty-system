...
Подарок держится около 25 ₽ по зафиксированной арифметике: четыре копии по 25 ₽ плюс товар
25 ₽ = 125 ₽. Категория без подарочного SKU честно отдаёт `sku_out_of_stock`.
