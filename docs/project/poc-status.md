...
Итоговая приёмка: **257 автоматизированных проверок** — **84 теста Python-движка**, **41 тест оценки**, **11 тестов общих контрактов**, **101 web-тест** и **20 Playwright-сценариев**. Также проходят TypeScript, ESLint, полная сборка и три валидатора RecSys. Браузерный пакет включает персональный путь, локальный Ads-аукцион с резервом, биллингом, защитой от повтора, бюджетом и частотным лимитом, обмен с reload/принятием/отклонением/крафтом, экран «Для X5», вкладку друзей, отказоустойчивый титул коллекции и открытие коробки с попаданием предмета в общую коллекцию.
...
Сейчас проходят **257 автоматизированных проверок**:
