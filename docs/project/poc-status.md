...
- реферальный расчёт и дружеский рейтинг по собранным наборам реализованы на синтетическом состоянии; отправки настоящего приглашения нет;
...
Сейчас проходят **239 автоматизированных проверок**:

| Набор | Результат |
| --- | ---: |
| Общие TypeScript-контракты | 11 |
| Webapp | 93 |
| Python decision engine | 78 |
