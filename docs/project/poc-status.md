...
Сейчас проходят **255 автоматизированных проверок**:
...
Все 18 браузерных сценариев из папки Playwright проходят: `bun run e2e:demo` завершается кодом 0.
